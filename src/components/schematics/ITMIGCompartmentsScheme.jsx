...
export function ITMIGCompartmentsScheme({ labels, highlight }) {
  ...
  return (
    <div className="overflow-x-auto rounded-xl bg-slate-50 dark:bg-slate-900/40 p-3">
      {/* Usamos un ancho fijo interno para garantizar que el panel doble no se aplaste en móviles */}
      <svg
        viewBox="0 0 760 410"
        style={{ minWidth: '700px', width: '100%' }}
        className="h-auto text-slate-600 dark:text-slate-300"
        xmlns="http://www.w3.org/2000/svg"
      >
        <defs>
          {/* Filtro de sombra nativo, ID único para evitar colisiones en la SPA */}
          <filter id="itmig-shadow" x="-20%" y="-20%" width="140%" height="140%">
        ...
        ========================================== */}
        <g id="axial-view" transform="translate(0, 0)">
          ...
          <g stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none">
            ...
            <path d="M 155,55 C 115,45 40,95 40,210 C 40,295 100,335 150,325 C 140,275 130,215 150,155 C 160,135 170,95 155,55 Z" />
            {/* Pulmón Izquierdo (derecha anatómica) */}
            <path d="M 225,55 C 265,45 340,95 340,210 C 340,295 280,335 230,325 C 240,275 250,215 230,155 C 220,135 210,95 225,55 Z" />
        ...
        <line x1="380" y1="30" x2="380" y2="360" stroke="currentColor" strokeWidth="1" strokeDasharray="4 4" className="text-slate-300 dark:text-slate-700" />

        {/* ==========================================
            PANEL DERECHO: CORTE SAGITAL
        ========================================== */}
        <g id="sagittal-view" transform="translate(380, 0)">
          <text x="190" y="20" textAnchor="middle" fontSize="14" fontWeight="bold" fill="currentColor">
        ...
        {/* ==========================================
            LEYENDA INFERIOR INTEGRADA
        ========================================== */}
        <g transform="translate(0, 390)" fontSize="12" fontWeight="600" fill="currentColor">
          {/* Prevascular */}
          <circle cx="120" cy="-4" r="6" fill="#3b82f6" filter="url(#itmig-shadow)" />
          <text x="135" y="0">{labels.prevascular}</text>

          {/* Visceral */}
          <circle cx="330" cy="-4" r="6" fill="#22c55e" filter="url(#itmig-shadow)" />
          <text x="345" y="0">{labels.visceral}</text>

          {/* Paravertebral */}
          <circle cx="520" cy="-4" r="6" fill="#f59e0b" filter="url(#itmig-shadow)" />
          <text x="535" y="0">{labels.paravertebral}</text>
        </g>
      </svg>
    </div>
  );
