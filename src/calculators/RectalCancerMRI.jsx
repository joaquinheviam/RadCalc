...
import { Card, Accordion, StickyBar, ResetIconButton, CopyIconButton, PreviewIconButton, ReportPreviewModal, InfoBox, References, UsageNotes, ReportBugLink, DonationButton, CalcDisclaimer, ZoomableDiagram } from '../components/shared/index.js';
...
export default function RectalCancerMRI() {
  ...
  const getReportText = () => buildReport();
  const handleCopy = () => {
