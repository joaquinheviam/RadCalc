...
export default function VIRADS() {
  ...
  const handleCopy = () => {
    ...
    const text = c.reportText(
      t2 || t.common.notEvaluated,
      dwi || t.common.notEvaluated,
      dce || t.common.notEvaluated,
      final
    );
      ...
      {final > 0 && (
        <StickyBar>
          <div className="min-w-0 text-center">
            ...
            <span className={`text-4xl font-black block mt-1 ${final >= 4 ? 'text-red-500' : final === 3 ? 'text-amber-500' : 'text-emerald-500'}`}>
              VI-RADS {final}
            </span>
          </div>
