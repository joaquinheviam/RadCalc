export default {
  ...
  peQanadli: ['tep', 'tromboembolismo pulmonar', 'embolia pulmonar', 'qanadli', 'indice de obstruccion', 'índice de obstrucción', 'angiotac pulmonar', 'pe-rads', 'perads', 'trombo en transito', 'trombo en tránsito', 'sobrecarga vd'],
  ildClassifier: ["epid", "ila", "uip", "fibrosis pulmonar", "fpi", "ats 2025", "pneumonia intersticial","srif", "bip", "neumonitis por hipersensibilidad", "hp", "nsip", "cop", "op", "tabaquismo",
  "plch", "amp", "dip", "borde recto", "panal exuberante"],
  ...
  liradsUs: ['li-rads us', 'liradsus', 'lirads ultrasonido', 'tamizaje chc', 'vigilancia hepatocarcinoma', 'ecografia de tamizaje hepatico', 'us-1', 'us-2', 'us-3', 'vis-a', 'vis-b', 'vis-c'],
  spleenSize: ['bazo', 'esplenomegalia', 'indice esplenico', 'índice esplénico', 'tamaño del bazo', 'splenocalc', 'chow', 'volumen esplenico'],
  cholangiocarcinoma: ['colangiocarcinoma', 'resecabilidad biliar', 'cancer biliar', 'cáncer biliar', 'bismuth', 'klatskin', 'colangiocarcinoma perihiliar', 'colangiocarcinoma distal', 'invasion vascular biliar', 'ksar'],
